...
export default function Pensions1() {
  const totalInitialValuesFromStore = useSelector(state => state.WorkflowInitialvalues.formCreationValues);
  ...
  const getEmpDetails = (values) => {
    ...
    LoadingServices.getValuestoForm(values.searchId).then((res) => {
  ...
  useEffect(() => {
    ...
    if(location.state!==undefined&&location.state!==""&&location.state!==null){
          ...
          <HERBUI.Card className="p-3">
            ...
            >
              <TabList>
                ...
                <Tab>
                  <IoDocumentsOutline className="tabicon" />
                  Pensioner Basic Pay Information
                </Tab>
                <Tab>
                  <IoDocumentsOutline className="tabicon" />
                  Pensioner Commutation Details
                </Tab>
                <Tab>
                  <IoDocumentsOutline className="tabicon" />
                  Pensioner Gratuity Details
                </Tab>
              ...
              <TabPanel>
                <Pensions2 empUniqueId={cfmsId} />
              </TabPanel>
              <TabPanel>
                <Pensions3 empUniqueId={cfmsId} />
              </TabPanel>
              <TabPanel>
                <Pensions4 empUniqueId={cfmsId}></Pensions4>
              </TabPanel>

              <TabPanel>
                <Pensions5 empUniqueId={cfmsId}></Pensions5>
              </TabPanel>
              <TabPanel>
                <Pensions6 empUniqueId={cfmsId}></Pensions6>
              </TabPanel>
              <TabPanel>
                <Pensions7 empUniqueId={cfmsId}></Pensions7>
              </TabPanel>
              <TabPanel>
